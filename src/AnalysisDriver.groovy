...
class AnalysisDriver 
{
	...
	{
		def project_root = "/home/yulong/SmartThingAppAnalysis/" //REPLACE with your project root
		...
		def sourceCodeDir = project_root + "/" + "SmartApps" //REPLACE with your dataset
		...
		STAnalysisAST stal = new STAnalysisAST(log)
		stal.loadCapRefAll(allCapsAll)
...
//		new File(sourceCodeDir).eachFile { file ->
		def file = new File("/home/yulong/SmartThingAppAnalysis/SmartApps/LeftUnlocked.txt.groovy")
			try {
